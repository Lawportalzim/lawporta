<%@ Page Title="Civil Cases" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"   CodeBehind="Civil.aspx.cs" Inherits="Site.Civil" %>
...
<asp:Content ID="Aside" runat="server" ContentPlaceHolderID="Aside">
    <%-- Category filter --%>
    <kay:CategoryFilter ID="Categories" runat="server" CategoryType="Civil" UrlTemplate="/cases/{0}/" />
</asp:Content>